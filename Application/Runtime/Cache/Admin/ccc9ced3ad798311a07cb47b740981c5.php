    ...
    <div class="container-fluid" >
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/thinkp/admin.php?c=content">文章管理</a>
            </li>
            <li class="active">
      ...
      <div class="row">
        <form action="/thinkp/admin.php" method="get">
          <div class="col-md-3">
              ...
              <table class="table table-bordered table-hover singcms-table">
                ...
                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><span class="sing_cursor glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($new["news_id"]); ?>" ></span>
                      ...
                      <a target="_blank" href="/thinkp/index.php?c=detail&a=view&id=<?php echo ($new["news_id"]); ?>" class="sing_cursor glyphicon glyphicon-eye-open" aria-hidden="true"  ></a>
...
<script>
  var SCOPE = {
    'edit_url' : '/thinkp/admin.php?c=content&a=edit',
    'save_url' : '/thinkp/admin.php?c=content&a=add',
    'set_status_url' : '/thinkp/admin.php?c=content&a=setStatus',
    'sing_news_view_url' : '/thinkp/index.php?c=view',
    'listorder_url' : '/thinkp/admin.php?c=content&a=listorder',
    'push_url' : '/thinkp/admin.php?c=content&a=push',
  }
</script>
<script src="/thinkp/Public/js/admin/common.js"></script>
