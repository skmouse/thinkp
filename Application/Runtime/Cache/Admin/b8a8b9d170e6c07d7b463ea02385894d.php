...
<script>
    var SCOPE = {
        'edit_url' : '/thinkp/admin.php?c=positioncontent&a=edit',
        'set_status_url' : '/thinkp/admin.php?c=positioncontent&a=setStatus',
        'save_url' : '/thinkp/admin.php?c=positioncontent&a=add',
        'listorder_url' : '/thinkp/admin.php?c=positioncontent&a=listorder',
    }
