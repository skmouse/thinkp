...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <script src="/thinkp/Public/js/kindeditor/kindeditor-all.js"></script>
  <div id="page-wrapper">
...
<script>
  var SCOPE = {
    ...
    'jump_url' : '/thinkp/admin.php?c=content',
    'ajax_upload_image_url' : '/thinkp/admin.php?c=image&a=ajaxuploadimage',
    'ajax_upload_swf' : '/thinkp/Public/js/party/uploadify.swf',
  };
...
<script>
  ...
  KindEditor.ready(function(K) {
    window.editor = K.create('#editor_singcms',{
      uploadJson : '/thinkp/admin.php?c=image&a=kindupload',
