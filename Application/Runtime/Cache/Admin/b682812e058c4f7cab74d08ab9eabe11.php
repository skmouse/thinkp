    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <i class="fa fa-dashboard"></i>  <a href="/thinkp/admin.php?c=admin">用户管理</a>
                    </li>
                    <li class="active">
...
<script>
    var SCOPE = {
        'save_url' : '/thinkp/admin.php?c=admin&a=add',
        'edit_url' : '/thinkp/admin.php?c=admin&a=edit',
        'set_status_url' : '/thinkp/admin.php?c=admin&a=setStatus',
        'index_url' : '/',
