    ...
    <div class="container-fluid" >
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <i class="fa fa-dashboard"></i>  <a href="/thinkp/admin.php?c=menu">菜单管理</a>
                    </li>
                    <li class="active">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a href="javascript:void(0)"><span class="glyphicon glyphicon-edit" id="singcms-edit" attr-id="<?php echo ($menu["menu_id"]); ?>"></span></a>    <a href="javascript:void(0)" attr-id="<?php echo ($menu["menu_id"]); ?>" id="singcms-delete"  attr-a="menu" attr-message="删除"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a></td>
...
<script>
    ...
    var SCOPE = {
        'save_url' : '/thinkp/admin.php?c=menu&a=add',
        'jump_url' : '/thinkp/admin.php?c=menu',
        'edit_url' : '/thinkp/admin.php?c=menu&a=edit',
        'set_status_url' : '/thinkp/admin.php?c=menu&a=setStatus',
        'listorder_url' : '/thinkp/admin.php?c=menu&a=listorder',
